...
<img id="background" class="absolute -z-10 -right-20 top-0 scale-x-[-1] max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" />
...
<p class="text-2xl">Here you can discover more info about us.</p>
</main>
</body>
</html>